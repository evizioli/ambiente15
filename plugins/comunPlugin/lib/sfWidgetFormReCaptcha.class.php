...
class sfWidgetFormReCaptcha extends sfWidgetForm
{
  ...
  public function configure($options = array(), $messages = array())
  {
	...
	$this->addOption('server_url_ssl', 'https://www.google.com/recaptcha/api.js');
  }
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    return sprintf('
		    	<script type="text/javascript" src="%s?hl=es" async defer></script>
  ...
  {
    return $this->getOption('server_url_ssl');
  }
}
