<?php
class ajaxConsultaMapaTipoAction extends   sfAction {
    ...
    public function execute( $request) {
        ...
        from muestra
        	inner join lugar_extraccion on muestra.lugar_de_extraccion_id= lugar_extraccion.id and muestra.tipo_id= lugar_extraccion.tipo_id
